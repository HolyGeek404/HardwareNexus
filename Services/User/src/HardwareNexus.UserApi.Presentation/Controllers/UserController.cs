...
using HardwareNexus.UserApi.Application.Features.Commands.AccountVerification;
using HardwareNexus.UserApi.Application.Features.Commands.Delete;
using HardwareNexus.UserApi.Application.Features.Commands.SignUp;
using HardwareNexus.UserApi.Application.Features.Queries.GetCurrentUser;
using HardwareNexus.UserApi.Application.Features.Queries.SignIn;
using HardwareNexus.UserApi.Application.Services;

namespace HardwareNexus.UserApi.Presentation.Controllers;
