...
public static partial class Logs
{
    ...
    [LoggerMessage(LogLevel.Information, "SignOut request received for user {email}")]
    public static partial void LogSignoutRequestReceivedUserEmail(ILogger logger, string email);

    [LoggerMessage(LogLevel.Information, "Successfully signed out user {email}")]
    public static partial void LogSuccessfullySignedOutUserEmail(ILogger logger, string email);

    [LoggerMessage(LogLevel.Error, "An error occurred while signing out user {email}")]
    public static partial void LogAnErrorOccurredWhileSigningOutUserEmail(ILogger logger,
        Exception ex, string email);
