...
namespace ProductApi.Api.Tests.Integration.Helpers;

public static class ProductFactory
{
    public static JsonElement CreateTestGpu()
    {
    ...
    public static JsonElement CreateTestCpu()
    {
        return JsonSerializer.SerializeToElement(new Cpu
        {
            Name = "TEST",
    ...
    public static JsonElement CreateTestCooler()
    {
        return JsonSerializer.SerializeToElement(new Cooler
        {
            Name = "TEST",
            Team = "TEST",
            CoolerType = "TEST",
