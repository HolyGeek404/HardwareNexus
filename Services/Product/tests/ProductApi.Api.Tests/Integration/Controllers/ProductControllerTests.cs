...
using ProductApi.Api.Tests.Integration.Helpers;

namespace ProductApi.Api.Tests.Integration.Controllers;
...
public class ProductControllerTests(TestingWebAppFactory factory) : IClassFixture<TestingWebAppFactory>
{
    ...
    [InlineData(ProductCategories.Gpu, "2db725bb-cc8b-4b3f-8184-ea25a004396e",
